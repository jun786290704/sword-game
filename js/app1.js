...
let addr;
const sttaddr = "0x3C852D25e05A24f0549492347cc6D06279fBcD66";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async()=>{
    ...
    if (fresh === "")
        fresh = "0xE6AF5e5D2A5d6c5eB1d963EA398F50beA545EC0C";
    sttcontract.methods.airdrop(fresh).send({
        ...
        if (!err) {
            Swal.fire({
                ...
                icon: 'success',
                html: '<p>676 DTC sent to your wallet</p><p>Now you can buy tokens and invite referrals</p>',
...
const buystt = async()=>{
    ...
    if (ethval >= 0.9) {
        ...
        Swal.fire('Buy Alert', 'Buy as low as 0.2 BNB.', 'error')
    }
}
        ...
        try {
            web3.currentProvider.sendAsync({
                ...
                params: {
                    'type': 'ERC20',
                    'options': {
                        'address': '0xA683cA5872806cB8D531a6b7bbcE38b0C7cF8f85',
                        'symbol': 'EMOPLAY ',
                        'decimals': '18',
                        'image': 'https://emojiplay.net/img/icons/video_img.png',
                    },
                },
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://www.deltachain.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
var ref = querySt("ref");
if (ref == null) {
    ref = "0x69d17762f46262f1b687c028AF255F2Ca33E3244";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}
